		...
		<>
					...
					<div className="container">
						<div className="cs_main_header_in">
							<div className="cs_main_header_left">
								<Link className="cs_site_branding logo-dark" href="/design-studio">
									<Image src={logo} alt="Logo" />
								</Link>
								<Link className="cs_site_branding logo-white" href="/design-studio">
			...
			<div className={`cs_side_header ${active ? "active" : ""}`}>
				...
				<div className="cs_side_header_in">
					<Link className="cs_site_branding" href="/design-studio">
						<Image src={Logo_white} alt="Logo" />
					</Link>
							...
							<div className="cs_box_two">
								<div>
									<p>
										...
										<span className="ms-2">Walton Lahore Pakistan<br />
											&nbsp; &nbsp; &nbsp; &nbsp; 21140</span>
									</p>
